...
<section id="contact" class="bg-gradient-to-r from-pink-500 via-purple-500 to-teal-500 py-16 text-white">
    <div class="container mx-auto px-6 fade-in text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-6"><?php echo e(__('messages.demo_title')); ?></h2>
        <p class="text-xl max-w-3xl mx-auto mb-10">
            <?php echo e(__('messages.demo_subtitle')); ?>

        </p>
        
        <div class="max-w-md mx-auto">
            <form id="demo-form" action="<?php echo e(route('api.request-demo')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                <div class="flex flex-col md:flex-row gap-4 justify-center">
                    <input type="email" id="email" name="email" placeholder="<?php echo e(__('messages.your_email')); ?>" 
                    ...
                    <button type="submit" class="btn-primary bg-pink-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-pink-700">
                        <?php echo e(__('messages.ask_for_demo')); ?>

                    </button>
                </div>
                
                <div id="form-success" class="hidden bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded" role="alert">
                    <p><?php echo e(__('messages.form_success')); ?></p>
                </div>
                
                <div id="form-error" class="hidden bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded" role="alert">
                    <p><?php echo e(__('messages.form_error')); ?></p>
                </div>
            </form>
            
            <p class="text-sm mt-4"><?php echo e(__('messages.demo_note')); ?></p>
        </div>
    </div>
</section>
<?php /**PATH /Users/martin/Laravel-Projekte/mindbeamer.io.landing/resources/views/components/contact.blade.php ENDPATH**/ ?>