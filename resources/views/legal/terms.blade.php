            ...
            <section>
                ...
                <div class="space-y-4 text-surface-700">
                    <p>{{ __('legal.data_protection') }} 
                        <a href="{{ route('privacy.policy', ['locale' => app()->getLocale()]) }}" class="text-primary hover:text-primary-700 underline">{{ __('legal.privacy_policy_link') }}</a>.
                    </p>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="space-y-4 text-surface-700">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p>{{ __('legal.email') }}: <a href="mailto:m.schenk@mindbeamer.io" class="text-primary hover:text-primary-700">m.schenk@mindbeamer.io</a></p>
                    </div>
                </div>
            </section>
        </div>
