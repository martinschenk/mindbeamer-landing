...
<header class="bg-gradient-to-r from-pink-500 via-purple-500 to-teal-500 shadow fixed top-0 w-full z-20" x-data="{ open: false }">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
        <a href="{{ route('home') }}" class="text-3xl font-bold text-white">MindBeamer</a>
        <nav class="hidden md:flex space-x-8">
            <a href="{{ route('home') }}#how-it-works" class="text-white hover:text-gray-200 font-medium">{{ __('messages.nav_how_it_works') }}</a>
            <a href="{{ route('home') }}#features" class="text-white hover:text-gray-200 font-medium">{{ __('messages.nav_features') }}</a>
            <a href="{{ route('home') }}#why-us" class="text-white hover:text-gray-200 font-medium">{{ __('messages.nav_why_us') }}</a>
            <a href="{{ route('home') }}#contact" class="text-white hover:text-gray-200 font-medium">{{ __('messages.nav_demo') }}</a>
    ...
    <div class="md:hidden" x-show="open" @click.away="open = false">
        <nav class="bg-white px-6 pb-4 space-y-4">
            <a href="{{ route('home') }}#how-it-works" class="block text-gray-700 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-purple-500 hover:to-teal-500 font-medium">{{ __('messages.nav_how_it_works') }}</a>
            <a href="{{ route('home') }}#features" class="block text-gray-700 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-purple-500 hover:to-teal-500 font-medium">{{ __('messages.nav_features') }}</a>
            <a href="{{ route('home') }}#why-us" class="block text-gray-700 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-purple-500 hover:to-teal-500 font-medium">{{ __('messages.nav_why_us') }}</a>
            <a href="{{ route('home') }}#contact" class="block text-gray-700 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-pink-500 hover:via-purple-500 hover:to-teal-500 font-medium">{{ __('messages.nav_demo') }}</a>
